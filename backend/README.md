...
## Project Structure
    ...
    ├── testapiautosetting_123003  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123003`
...
2. Clone this repo and `cd testapiautosetting_123003`
